...
int main(int argc,char **argv) 
{
	...
	try
	{
		...
		cout << "==================== Get recommend list for each movie :==================== " << endl;
		schedule->getRecommendList();
		
		cout << "==================== Get final movies statistics ==================== " << endl;
		vector<pair<int, int>> recommendMovies;
		recommendMovies=schedule->getRecommendMovies();
